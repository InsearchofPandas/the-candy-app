...
class Sort extends React.Component {
  render() {
    return(<div className="bg-grey-orange border-2 border-white opacity-95 rounded-lg p-3 my-1">
      ...
      <div className="border border-black p-75 my-50 rounded-sm bg-white-orange hover:bg-orange-dark" name='competitorname' id='0' onClick={this.props.sort}>Name</div>
      <div className="border border-black p-75 my-50 rounded-sm bg-white-orange hover:bg-orange-dark" name='winpercent' id='1' onClick={this.props.sort}>Popularity</div>
      <div className="border border-black p-75 my-50 rounded-sm bg-white-orange hover:bg-orange-dark" name='sugarpercent' id='2' onClick={this.props.sort}>Sugar Content</div>
      <div className="border border-black p-75 my-50 rounded-sm bg-white-orange hover:bg-orange-dark" name='pricepercent' id='3' onClick={this.props.sort}>Price</div>
      <div className="flex text-black bg-black pt-1 ">
      <div className={this.props.sortOrder[this.props.sortState].order === "asc"
          ? "text-white"
        ...
        <div className={this.props.sortOrder[this.props.sortState].order === "desc"
            ? "text-white"
            : "text-grey-dark" + " hover:text-purple-darker"}>
